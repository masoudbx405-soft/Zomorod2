...
object ZomorrodNotificationManager {
    ...
    private const val CHANNEL_ORDERS_NAME = "ماموریت‌ها و سفارشات جدید زمرد"
    ...
    private const val CHANNEL_SERVICE_NAME = "سرویس پس‌زمینه زمرد"
    ...
    fun createServiceNotification(
        ...
        return NotificationCompat.Builder(context, CHANNEL_SERVICE_ID)
            .setSmallIcon(R.mipmap.ic_launcher)
            .setContentTitle("قالیشویی زمرد • سرویس آنلاین پس‌زمینه")
    ...
    fun testSoundAndVibration(context: Context) {
        ...
        val builder = NotificationCompat.Builder(context, CHANNEL_ORDERS_ID)
            ...
            .setContentText("سیستم هشدار آنلاین قالیشویی زمرد در حالت آماده‌باش قرار دارد.")
            .setPriority(NotificationCompat.PRIORITY_HIGH)
            .setContentIntent(pendingIntent)
            .setAutoCancel(true)
